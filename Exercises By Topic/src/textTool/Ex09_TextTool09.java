...
class Ex09_TextTool09 extends Frame implements WindowListener {
	// TextArea의 라인의 내용 중 중복된 것을 제거하고 정렬해서 보여주며, 중복된 라인의 개수를 보여주는 'distinct2'버튼을 구현하라.
        ...
        btn[n++].addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent ae) {
        		...
        		while(it.hasNext()) {
        			...
        			sb.append(entry.getKey() + regex + entry.getValue()).append(CR_LF);
        		}
	...
	public static void main(String[] args) {
    	Ex09_TextTool09 win = new Ex09_TextTool09("Text Tool");
        win.show();
	} // main() 끝.

    // 생성자!!
    public Ex09_TextTool09(String title) {
    	super(title);
